...
<html lang="en">
	...
	<body>
		...
		<div class="container theme-showcase" role="main">
			...
			<img src="${urlPublic}/imagenes/login.png" width="136" height="136" class="center">
			
			<form class="form-signin" action="${urlRoot}login" method="post">  
			
				<!-- en caso de credenciales no validas -->
				<c:if test="${param.error != null}">
					<img src="${urlPublic}/imagenes/error.png" width="48" height="48"
						class="center">
					<h4 class="form-signin-heading" style="color: red">Usuario o contraseña incorrectos</h4>
				</c:if>
				<!--  -->
