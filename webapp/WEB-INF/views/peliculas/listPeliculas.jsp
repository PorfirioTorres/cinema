...
<html lang="en">
  <head>
    ...
    <spring:url value="/peliculas" var="urlPag" />
  ...
  <body>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="table-responsive">
            ...
            <c:forEach items="${peliculas.content}" var="pelicula">
            	<tr>
	                ...
	                <c:choose>
	                	...
	                	<c:otherwise>
	                		<td><span class="label label-warning">${pelicula.estatus}</span></td>
	                	</c:otherwise>
	                </c:choose>
	                <td>
	                    <a href="${urlEdit}/${pelicula.id}" class="btn btn-success btn-sm" role="button" title="Edit" >
	                    <span class="glyphicon glyphicon-pencil"></span></a>
	                    <a href="${urlDelete}/${pelicula.id}/${pelicula.detalle.id}" class="btn btn-danger btn-sm" role="button" title="Eliminar" >
        ...
        <nav aria-label="">
			<ul class="pager">
				<li><a href="${urlPag}/indexPaginate?page=${peliculas.number - 1 }">Anterior</a></li>
				<li><a href="${urlPag}/indexPaginate?page=${peliculas.number + 1 }">Siguiente</a></li>
			</ul>
		</nav>
      </div>
