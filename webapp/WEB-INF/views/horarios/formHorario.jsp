...
<html lang="en">
	...
	<jsp:include page="../includes/menu.jsp"></jsp:include>
		...
		<div class="container theme-showcase" role="main">
			...
			<spring:url value="/horarios/save" var="urlForm" /><!-- url usada en el actio y apunta al metodo save -->
				...
				<div class="row">         
					<div class="col-sm-3">
						<div class="form-group">
							...
							<form:select id="idPelicula" path="pelicula.id" items="${peliculas}" itemValue="id"
								itemLabel="titulo" class="form-control">
