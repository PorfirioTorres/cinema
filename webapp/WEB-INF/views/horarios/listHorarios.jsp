  ...
  <body>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="table-responsive">
        <table class="table table-hover table-striped table-bordered">
            ...
            <c:forEach items="${horarios.content}" var="horario">
            	<tr>
	                ...
	                <td>
	                    <a href="${urlEdit}/${horario.id}" class="btn btn-success btn-sm" role="button" title="Edit" >
        ...
        <nav aria-label="">
			<ul class="pager">
				<li><a href="${urlPag}/indexPaginate?page=${horarios.number - 1 }">Anterior</a></li>
				<li><a href="${urlPag}/indexPaginate?page=${horarios.number + 1 }">Siguiente</a></li>
			</ul>
		</nav>
      </div>
